(() => {
    ...
    (() => {
        ...
        window.addEventListener("click", (function(event) {
            let counter, productCard, price, prodTotal, totalSum;
            let cartWrapper, productInfo, cartItemHTML, itemInCart, cartQuantity, cartPrice, totalSumOrder, formBtn;
            let currLang, prodNum, prodVol;
            if ("plus" === event.target.dataset.action || "minus" === event.target.dataset.action) {
                const counterParent = event.target.closest(".order-counter");
                productCard = event.target.closest(".order-product__item");
                price = productCard.querySelector("[data-prod-price]");
                prodTotal = productCard.querySelector("[data-prod-total]");
                totalSum = document.querySelector("[data-cart-total]");
                counter = counterParent.querySelector("[data-counter]");
                totalSumOrder = document.querySelector("[order-total]");
                formBtn = document.querySelector(".payment-order__button");
                currLang = document.querySelector(".language-select__current").textContent;
                cartWrapper = document.querySelector(".cart-order__body");
                productInfo = {
                    id: productCard.dataset.id,
                    imgSrc: productCard.querySelector("img").getAttribute("src"),
                    title: productCard.querySelector(".order-product__title").innerText,
                    itemTotal: productCard.querySelector("[data-prod-price]").innerText,
                    quantity: productCard.querySelector("[data-counter]").innerText,
                    volume: productCard.querySelector(".order-product__volume").innerText
                };
                if ("EN" === currLang) {
                    prodNum = "Quantity";
                    prodVol = "Volume";
                ...
                cartItemHTML = `<div class="cart-order__item cart-item" data-id="${productInfo.id}">\n\t\t<div class="cart-item__row">\n\t\t\t<div class="cart-item__image">\n\t\t\t\t<img src="${productInfo.imgSrc}" alt="Зображення">\n\t\t\t</div>\n\t\t\t<div class="cart-item__name">${productInfo.title}</div>\n\t\t\t<div class="cart-item__price"><span data-cart-price>${productInfo.itemTotal}</span>грн</div>\n\t\t</div>\n\t\t<div class="cart-item__row">\n\t\t\t<div class="cart-item__quantity">${prodNum}:<span data-cart-quantity>1</span></div>\n\t\t\t<div class="cart-item__volume">${prodVol}:<span data-cart-volume>${productInfo.volume}</span></div>\n\t\t</div>\n\t\t</div>`;
                itemInCart = cartWrapper.querySelector(`[data-id="${productInfo.id}"]`);
            }
            if ("plus" === event.target.dataset.action) {
                counter.innerText = ++counter.innerText;
                prodTotal.innerText = (parseInt(prodTotal.innerText) + parseInt(price.innerText)).toFixed(2);
                totalSum.innerText = (parseInt(totalSum.innerText) + parseInt(price.innerText)).toFixed(2);
                totalSumOrder.innerText = totalSum.innerText;
                if (itemInCart) {
                    cartQuantity = itemInCart.querySelector("[data-cart-quantity]");
                    cartQuantity.innerText = counter.innerText;
                    cartPrice = itemInCart.querySelector("[data-cart-price]");
                    cartPrice.innerText = (parseInt(price.innerText) + parseInt(cartPrice.innerText)).toFixed(2);
                } else cartWrapper.insertAdjacentHTML("beforeend", cartItemHTML);
                if (parseFloat(totalSum.innerText) > 0) formBtn.disabled = false; else formBtn.disabled = true;
            }
            if ("minus" === event.target.dataset.action) {
                if (parseInt(counter.innerText) > 0) counter.innerText = --counter.innerText;
                if (totalSum.innerText > 0 && parseInt(prodTotal.innerText) > 0) {
                    totalSum.innerText = (parseInt(totalSum.innerText) - parseInt(price.innerText)).toFixed(2);
                    totalSumOrder.innerText = totalSum.innerText;
                }
                if (prodTotal.innerText > 0) prodTotal.innerText = (parseInt(prodTotal.innerText) - parseInt(price.innerText)).toFixed(2);
                if (itemInCart) {
                    cartQuantity = itemInCart.querySelector("[data-cart-quantity]");
                    cartQuantity.innerText = counter.innerText;
                    cartPrice = itemInCart.querySelector("[data-cart-price]");
                    cartPrice.innerText = (parseInt(cartPrice.innerText) - parseInt(price.innerText)).toFixed(2);
                    if (0 == cartQuantity.innerText) cartQuantity.closest(".cart-item").remove();
                }
                if (parseFloat(totalSum.innerText) > 0) formBtn.disabled = false; else formBtn.disabled = true;
            }
        }));
        function buildProdListForSend() {
            let productArray = [];
            let array = document.querySelector(".cart-order__body").children;
            let obj = {};
            for (let item of array) {
                obj = {};
                obj.title = item.querySelector(".cart-item__name").textContent;
                obj.volume = item.querySelector("[data-cart-volume]").textContent;
                obj.price = parseInt(item.querySelector("[data-cart-price]").textContent) / parseInt(item.querySelector("[data-cart-quantity]").textContent);
                obj.quantity = item.querySelector("[data-cart-quantity]").textContent;
                obj.sum = item.querySelector("[data-cart-price]").textContent;
                productArray.push(obj);
            }
            obj = {};
            obj.orderTotalSum = document.querySelector("[data-cart-total]").textContent;
            productArray.push(obj);
            return productArray;
        }
            ...
            async function formSubmitAction(form, e) {
                ...
                if (0 === error) {
                    ...
                    if (ajax) {
                        ...
                        formData.append("orderProductsList", JSON.stringify(buildProdListForSend()));
        ...
        const attrPicker = document.querySelector("#data-input");
        if (attrPicker) {
            const picker = datepicker_min("[data-datepicker]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд" ],
                customMonths: [ "Січ", "Лют", "Бер", "Кві", "Тра", "Чер", "Лип", "Сер", "Вер", "Жов", "Лис", "Гру" ],
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-product_1")) new core(".slider-product_1", {
                ...
                grabCursor: true,
                pagination: {
                    el: ".slider-product__pagination_1",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-product__button-prev_1",
                    nextEl: ".slider-product__button-next_1"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-product_2")) new core(".slider-product_2", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".slider-product__pagination_2",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-product__button-prev_2",
                    nextEl: ".slider-product__button-next_2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-product_3")) new core(".slider-product_3", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".slider-product__pagination_3",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-product__button-prev_3",
                    nextEl: ".slider-product__button-next_3"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-product_4")) new core(".slider-product_4", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".slider-product__pagination_4",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-product__button-prev_4",
                    nextEl: ".slider-product__button-next_4"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-product_5")) new core(".slider-product_5", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".slider-product__pagination_5",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-product__button-prev_5",
                    nextEl: ".slider-product__button-next_5"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-equipment")) new core(".slider-equipment", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".slider-equipment__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-equipment__button-prev",
                    nextEl: ".slider-equipment__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
